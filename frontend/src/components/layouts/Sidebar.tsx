...
export default function Sidebar({ isOpen, setIsOpen }: { isOpen: boolean, setIsOpen: (val: boolean) => void }) {
  ...
  const navItems = [
    ...
    { name: 'COA', path: '/categories', icon: 'category', adminOnly: true },
    { name: 'Receipts', path: '/receipts', icon: 'receipt_long', adminOnly: false },
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center px-6 pt-6 pb-2 mb-4 md:mt-0">
          ...
          <img src="/Logo-Intek-RED.png" alt="Intek Logo" className="h-10 object-contain dark:brightness-200 dark:contrast-200" />
        </div>
