...
export default function Receipts() {
  ...
  const canManage = !!user; // Admin dan Operator sama-sama bisa edit & delete
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                Manage all your transaction receipts
              </p>
            </div>
          </div>
                ...
                <table className="w-full text-left border-collapse min-w-[700px]">
                  <thead>
                    <tr className="bg-gray-50/50 dark:bg-[#202022] border-b border-gray-100 dark:border-gray-800">
                      <th className="px-6 py-5 text-[13px] font-bold text-[#1e293b] dark:text-gray-300 uppercase tracking-wider">
                        Date
                      </th>
                      <th className="px-6 py-5 text-[13px] font-bold text-[#1e293b] dark:text-gray-300 uppercase tracking-wider">
                        Buyer
                      ...
                      {canManage && (
                        <th className="px-6 py-5 text-[13px] font-bold text-[#1e293b] dark:text-gray-300 uppercase tracking-wider text-right">
                          Actions
                        </th>
                      )}
                    </tr>
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    {notes.map((note: any) => (
                      <tr
                        key={note.id}
                        className="hover:bg-gray-50/80 dark:hover:bg-[#202022] transition-colors group bg-white dark:bg-[#1a1a1c]"
                      >
                        ...
                        {canManage && (
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-end space-x-2">
                              <button
                                onClick={() =>
                                  navigate(`/receipts/${note.id}/edit`)
                                }
